...
module.exports = async ({ deployments }) => {
  ...
  await registry.setSubnodeOwner(ethers.utils.namehash('eth'), ethers.utils.id('oddys'), owner, { from: owner });
  await registry.setResolver(ethers.utils.namehash('oddys.eth'), resolver.address, { from: owner });
};
